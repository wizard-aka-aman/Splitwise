...
namespace Splitwise.Controllers
{
    ...
    public class ExpenseController : Controller
    {
        ...
        [HttpGet("GetActivity/{name}/{start}")]
        public List<ExpenseWithGroupNameDTO> GetActivity(string name,int start)
        {

            var items = _expenseRepository.GetAllActivity(name,start);
            return items;
        }
